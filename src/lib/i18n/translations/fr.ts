export const fr: Record<string, string> = {
  ...
  "footer.buildYourBox": "Composez Votre Boite",
  "footer.allProducts": "Tous les Produits",
  "footer.subscriptions": "Abonnements",
  "footer.giftCards": "Cartes Cadeaux",
  "footer.forDealers": "Pour les Distributeurs",
  "footer.wholesale": "Vente en Gros",
  "footer.aviationMarine": "Aviation et Marine",
  "footer.partnerWithUs": "Devenez Partenaire",
  "footer.helpCenter": "Centre d'Aide",
  "footer.shippingInfo": "Informations de Livraison",
  "footer.returns": "Retours",
  "footer.brandDescription":
    "Alimentation premium longue conservation au gout de fait maison. Composez votre boite parfaite et savourez des repas gastronomiques partout.",
