export const pt: Record<string, string> = {
  ...
  "footer.ourStory": "Nossa Historia",
  "footer.careers": "Carreiras",
  "footer.buildYourBox": "Monte sua Caixa",
  "footer.allProducts": "Todos os Produtos",
  "footer.subscriptions": "Assinaturas",
  "footer.giftCards": "Cartoes Presente",
  "footer.forDealers": "Para Distribuidores",
  "footer.wholesale": "Atacado",
  "footer.aviationMarine": "Aviacao e Marinha",
  "footer.partnerWithUs": "Seja Nosso Parceiro",
  "footer.helpCenter": "Central de Ajuda",
  "footer.shippingInfo": "Informacoes de Envio",
  "footer.returns": "Devolucoes",
  "footer.brandDescription":
    "Alimentos premium de longa duracao com sabor de feito na hora. Monte sua caixa perfeita e aproveite refeicoes gourmet em qualquer lugar.",
